...
/**
 * <p>Classe Java pour compteListeResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="compteListeResponse">
 *   <complexContent>
...
@XmlType(name = "compteListeResponse", propOrder = {
    "_return"
})
public class CompteListeResponse {
